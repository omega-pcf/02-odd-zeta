...
for $\mathrm{Re}(s)>1$ (Euler~\cite{euler1744variae}) follows from unique
...
continuation (identity theorem for Dirichlet series; Riemann~\cite{riemann1859ueber}).
...
\end{theorem}
\begin{proof}
\Cref{eq:hurwitz-rep} is well-established (\cite[Thm.~12.6]{apostol2013introduction}).
