...
double-angle formula. Verified numerically to machine precision (see \cref{sec:verification}):
...
% ------------------------------------------------------------------
\subsubsection{Numerical case study: $\zeta(3)$}\label{ssec:zeta3-example}
% ------------------------------------------------------------------
