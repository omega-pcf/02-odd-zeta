...
% ------------------------------------------------------------------
\subsection{Bekenstein--Hawking entropy and $L$-values}%
...
% ------------------------------------------------------------------
\subsection{Geometric unity at $\tau_{\mathrm{PCF}}=i$}%
...
% ------------------------------------------------------------------
\subsection{Algebraic symmetry via $\mathbb{Z}_2\times\mathbb{Z}_2$}%
