...
arity where the Lawvere~\cite{lawvere1969diagonal} obstruction is simultaneously effective
...
\item The Euler product $\prod_p f_p(s)$ determines $\zeta(s)$ on
  $\mathrm{Re}(s)>1$ (Euler~\cite{euler1744variae}), and hence on all
  of~$\mathbb{C}$ by analytic continuation (Riemann~\cite{riemann1859ueber}).
...
\begin{enumerate}
\item \textbf{Euler product identity} (Euler~\cite{euler1744variae}):
