...
% ------------------------------------------------------------------
\subsection{The First Bridge: Intrinsic Correspondence between Bekenstein--Hawking Entropy and $L$-values}%
...
% ------------------------------------------------------------------
\subsection{The Second Bridge: Geometric Unity at $\tau_{\mathrm{PCF}}=i$}%
...
% ------------------------------------------------------------------
\subsection{The Third Bridge: Universal Algebraic Symmetry via $\mathbb{Z}_2\times\mathbb{Z}_2$ Galois Groups}%
...
% ------------------------------------------------------------------
\subsection{Synthesis: Implications of the Three Physical Bridges}%
\label{ssec:bridges-summary}
% ------------------------------------------------------------------

\begin{enumerate}
\item \textbf{The First Bridge (Intrinsic Correspondence):}
...
\item \textbf{The Second Bridge (Geometric Unity):}
...
\item \textbf{The Third Bridge (Algebraic Symmetry via $\mathbb{Z}_2\times\mathbb{Z}_2$):}
...
Together, the three bridges discharge the \texttt{bridge\_axiom} and resolve the
...
produces the self-duality of $L(1,\chi_5)$ (Bridge~3).
