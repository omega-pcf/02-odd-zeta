...
(b)~analytic continuation (Riemann~\cite{riemann1859ueber}),
...
justification for \texttt{bridge\_axiom}: Euler~\cite{euler1744variae},
Gelfand~\cite{gelfand1941normierte}, and Dunford--Schwartz~\cite{DunfordSchwartz}.
...
The classical inputs (Euler~\cite{euler1744variae},
...
(cf.~\S2.6 of~\cite{V11}; \cite{weil1979lettre}).
