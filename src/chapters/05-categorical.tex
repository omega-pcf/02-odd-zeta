...
\item[\textup{(b)}] $F_{\mathrm{spec}}$ depends on
  $\vert\ker G\vert=2$ (\cref{cor:S3-from-euler,lem:spectral-re}).
...
(b) $\vert\ker G\vert=2$ $\to$ $\mu_3=1/2$ $\to$ arity uniqueness $\to$
$S_3$ $\to$ $\omega^k/2$.
...
produces~$\OmH$ via $\vert\ker G\vert=2\to\mu_3=1/2\to S_3\to\omega^k/2$
...
$\vert\ker G\vert=2$ under $U_2\colon\mathbf{Hilb}\to\mathbf{Met}$.
...
\item[\textup{(i$'$)}] The span
  ...
  $\vert\ker G\vert=2$ (\cref{thm:bridge3}), verified
...
\item[\textup{(ii$'$)}] The upper bound
  ...
  $\mathrm{spec}(\OmH) = \tfrac{1}{2}\{1,\omega,\omega^2\}$
  (via $\vert\ker G\vert=2$, \cref{cor:S3-from-euler}),
