...
proposals for $\mathbb{F}_1$-geometry~\cite{ConnesDouglasSchwarz}---all descended from Weil's~\cite{weil1979lettre}
...
(Cardano, Gauss, Argand~\cite{argand1806essai})---the triple
...
logical diagnosis.
Lawvere~\cite{lawvere1969diagonal} proved that in any cartesian closed category
