...
$n = p_1^{a_1}\cdots p_r^{a\_r}$, reorganising the sum into the Euler
...
state $|p_1^{a_1},\ldots,p_r^{a\_r}\rangle$; and the partition function of
...
$\zeta$ positive $\implies \mathrm{Re}(s)=1/2$ & \lean{zeta_positive_spectral_half} & transport \\
\midrule
...
\[
  ...
  \;\to\;
  \underbrace{\prod_p f\_p(s)}_{\textup{Euler product on }\mathbb{C}}
  \;\to\;
